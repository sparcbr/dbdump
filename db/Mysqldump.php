...
class Mysqldump
{
    ...
    public function __construct(
        ...
        $dumpSettingsDefault = array(
            ...
            'no-data' => true, // array of tables (support regexps), or true to ignore all
            'reset-auto-increment' => true,
			'hide-saved-cs-client' => true,
    ...
    {
        $header = '';
        if (!$this->dumpSettings['skip-header-comments']) {
...
class TypeAdapterMysql extends TypeAdapterFactory
{
    ...
    public function create_table($row)
    {
		...
		if (!$this->dumpSettings['hide-saved-cs-client']) {
			...
			$ret = $createTable.";".PHP_EOL.PHP_EOL;
		}
    ...
    public function show_tables()
    {
        ...
        return "SELECT TABLE_NAME AS tbl_name ".
            ...
            "WHERE TABLE_TYPE='BASE TABLE' AND TABLE_SCHEMA='${args[0]}' ORDER BY TABLE_NAME";
    }
